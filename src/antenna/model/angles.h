...
struct Angles
{
  ...
  /**
    ...
    * theta is the inclination between 0 and M_PI
    * phi is the azimuth between -M_PI and M_PI
    *
    * This method should be called every time an operation is performed on the angles.
    */
