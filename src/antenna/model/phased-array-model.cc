...
PhasedArrayModel::PhasedArrayModel (void)
{
...
PhasedArrayModel::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::PhasedArrayModel")
    ...
    .AddAttribute ("IsotropicElements",
               ...
               BooleanValue (false),
               MakeBooleanAccessor (&PhasedArrayModel::m_isIsotropic),
               MakeBooleanChecker ())
  ;
  return tid;
}
...
bool
PhasedArrayModel::IsOmniTx (void) const
{
  NS_LOG_FUNCTION (this);
  return m_isOmniTx;
}
...
void
PhasedArrayModel::ChangeToOmniTx (void)
{
  NS_LOG_FUNCTION (this);
  m_isOmniTx = true;
}
...
PhasedArrayModel::SetBeamformingVector (const Angles a)
{
  ...
  //NEED TO CALCULATE m_beamformingVector = beamformingVector;
}

const PhasedArrayModel::ComplexVector &
PhasedArrayModel::GetBeamformingVector(void) const
{
  NS_LOG_FUNCTION (this);
...
PhasedArrayModel::GetAntennaElement(void) const
{
  NS_LOG_FUNCTION (this);
...
PhasedArrayModel::GetElementFieldPattern (Angles a) const
{
  NS_LOG_FUNCTION (this);
...
double
PhasedArrayModel::GetRadiationPattern (double thetaRadian, double phiRadian) const
{
  if (m_isIsotropic)
  {
    return 0;
...
Vector
PhasedArrayModel::GetElementLocation (uint64_t index) const
{
  NS_LOG_FUNCTION (this);
...
uint64_t
PhasedArrayModel::GetNumberOfElements (void) const
{
  NS_LOG_FUNCTION (this);
